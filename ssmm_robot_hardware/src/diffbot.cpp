#include "ssmm_robot_hardware/diffbot.hpp"
...
hardware_interface::return_type ssmm_robot_hardware::DiffBotSystemHardware::write()
{
...
PLUGINLIB_EXPORT_CLASS(
  ssmm_robot_hardware::DiffBotSystemHardware, hardware_interface::SystemInterface)
